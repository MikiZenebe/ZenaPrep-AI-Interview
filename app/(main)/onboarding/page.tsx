      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-5xl leading-tight tracking-tighter mt-1">
            ...
            <br />
            <GoldTitle>using ZenaPrept?</GoldTitle>
          </h1>
          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            {ONBOARDING_ROLES.map((r) => (
              <button
                ...
                className="text-left rounded-2xl p-8 border border-white/10 bg-[#0f0f11] hover:border-amber-400/20 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
              >
                    ...
                    <button
                      ...
                      className={`text-xs px-4 py-2 rounded-lg border ${
                        form.yearsExp === opt.value
                          ? "border-[#3AE4B2]/40 bg-[#3AE4B2]0 text-[#3AE4B2]"
