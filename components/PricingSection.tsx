        ...
        return (
          ...
          >
            ...
            {plan.featured && !isActive && (
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#3AE4B2] text-[#0a0a0b] text-xs font-bold tracking-wide uppercase px-3.5 py-1 rounded-full whitespace-nowrap">
                Most Popular
              </span>
            )}
            ...
            <div className="flex items-end gap-1 mb-1.5">
              <span
                className={`font-serif text-5xl leading-none tracking-tight ${
                  plan.featured
                    ? "bg-linear-to-br from-[#3AE4B2] to-[#2bab85] bg-clip-text text-transparent"
            ...
            <p className="text-sm text-[#3AE4B2] mb-7">{plan.credits}</p>
            ...
            <ul className="space-y-3 mb-9 flex-1">
              {plan.features.map((f) => (
                ...
                >
                  <span className="text-[#3AE4B2] text-xs mt-0.5">✓</span>
                  {f}
                </li>
              ))}
            </ul>
            ...
            {isActive ? (
              ...
              <Button
                variant={plan.featured ? "green" : "default"}
                disabled
